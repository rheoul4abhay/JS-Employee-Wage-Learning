class EmployeePayroll {
    ...
    validateDate(date){
        ...
        if(givenDate > today){
            throw new Error("Invalid Start Date: Date cannot be in future")
        }
        return givenDate;
    }
    ...
    validateGender(gender){
        ...
        if(!genderRegex.test(gender)){
            throw new Error("Invalid Gender: It can either be 'M' or 'F'");
        }
        return gender;
    }
...
try {
    ...
    //Invalid name
    // let emp3 = new EmployeePayroll(103, "jake", 55000, "M", "2023-08-01");

    //Invalid startdate
    // let emp4 = new EmployeePayroll(103, "Jerry", 65000, "M", "2025-08-03");

    //Invalid gender
    // let emp5 = new EmployeePayroll(103, "Juliet", 35000, "f", "2023-08-01");
